...
/*        var wall = this.add.sprite(20, 0, 'wall');
        ...
        goalsensor1         = this.add.sprite(margX+55*sizer, margY+259, 'goalsensor');
        goalsensor2         = this.add.sprite(margX+842*sizer, margY+259, 'goalsensor');
   ...
   /* let dir = (angle - this.repeatAngle[n+1]) / (Math.PI * 2);
    ...
    if (this.authorative === true){
        ...
        if (goalscored === false){                   //to register goal only once
            ...
            {
                if ((this.lastY < margY+247 || this.lastY > margY+350)){
